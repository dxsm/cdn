...
!function(e, t) {
    ...
    , function(e, t) {
        function aru(index){
          return "<img class='emoji' src='https://cdn.jsdelivr.net/gh/dxsm/cdn/lib/valine/img/aru/" + index + ".png'>";
        }
        function tieba(str){
          return "<img class='emoji' src='https://cdn.jsdelivr.net/gh/dxsm/cdn/lib/valine/img/tieba/" + str + ".png'>";
        }
        function qq(str) {
          return "<img class='emoji' src='https://cdn.jsdelivr.net/gh/dxsm/cdn/lib/valine/img/qq/" + str + ".gif'>";
        }
        e.exports = {
            aru151: aru(151),
            贴吧what: tieba('what'),
